//! Reporting dates in the proleptic Gregorian calendar.
//!
//! ISO 8601 `YYYY-MM-DD` dates are values the interpreter can compare for
//! ordering, so that rules over `appliesFrom` dates evaluate identically
